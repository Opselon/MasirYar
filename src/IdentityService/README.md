...
- **Application**: شامل منطق کسب‌وکار و موارد استفاده (Use Cases).
...
این میکروسرویس دارای یک مجموعه کامل از تست‌های خودکار است تا از کیفیت و پایداری کد اطمینان حاصل شود. برای اطلاعات بیشتر در مورد انواع تست‌ها و نحوه اجرای آن‌ها، به مستندات موجود در پوشه تست مراجعه کنید:

-   [استراتژی تست IdentityService](./Tests/README.md)
